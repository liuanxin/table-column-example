...
public class TableColumnConfig {
    ...
    public List<TableColumnRelation> relationList() {
        return Arrays.asList(
                new TableColumnRelation("t_buyer", "id", TableRelationType.ONE_TO_ONE, "t_order", "buyer_id"),
                new TableColumnRelation("t_seller", "id", TableRelationType.ONE_TO_ONE, "t_order", "seller_id"),
